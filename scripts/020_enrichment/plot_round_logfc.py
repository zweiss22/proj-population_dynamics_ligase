...
for main_round in range(1, 9):
    ...
    for seq in top_10_seqs:
        ...
        for round_num in range(1, 9):
            ...
            counts.append(round_seqs.count(seq)/np.mean(list(Counter(round_seqs).values())))
    ...
    fig.colorbar(im, ax=axs[main_round-1], label='Log fold increase in counts')

plt.show()

pd.DataFrame(all_counts).to_csv('/Users/zoeweiss/Desktop/evolution_manuscript/proj-population_dynamics_ligase/scripts/020_enrichment/log_1p_fc_counts_by_round.csv')
